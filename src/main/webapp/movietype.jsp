...
<script type="text/javascript">
	...
	function update(){
        ...
        $("#ff").form("reset");
      	//修改记录的请求地址
		url = "MovieType/update?id="+array[0].id;
		//表单填充内容
